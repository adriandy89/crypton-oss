 ...
 *
 * Esto mira lo acumulado cada minuto y avisa ANTES. Va también aquí y no solo
 * en el worker porque los dos comparten el depósito por IP
 * (`WORKER_EGRESS_ID`): mirarlo en uno solo sería ver media historia, y lo que
 * suele pedir de más por este lado es el gráfico de la app, que arrastra
 * histórico en páginas de trescientas velas.
 */
@Injectable()
